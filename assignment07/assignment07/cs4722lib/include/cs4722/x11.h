...
namespace cs4722 {
	...
	public:
        ...
        /**
          ...
          */
        static color color_rgba(const GLubyte r, const GLubyte g, const GLubyte b, const GLubyte a)
//			: color(r/255.0, g/255.0, b/255.0, a/255.0)
       ...
       * @param b   Blue component, in the range from 0 to 255, inclusive
       */
        static color color_rgb(const GLubyte r, const GLubyte g, const GLubyte b)
//			: color(r, g, b, 255)
		{
...
//		color(const color& c) = default;
         ...
         */
        GLubyte r() {
            return (GLubyte)(color_vec.r * 255);
        }
         ...
         */
        GLubyte g() {
            return (GLubyte)(color_vec.g * 255);
        }
         ...
         */
        GLubyte b() {
            return (GLubyte)(color_vec.b * 255);
        }
         ...
         */
        GLubyte a() {
            return (GLubyte)(color_vec.a * 255);
        }
		...
		color mix(double alpha, const color &other) {
            color rtval(alpha * color_vec.r + (1- alpha) * other.color_vec.r,
                        alpha * color_vec.g + (1- alpha) * other.color_vec.g,
                        alpha * color_vec.b + (1- alpha) * other.color_vec.b,
                        alpha * color_vec.a + (1- alpha) * other.color_vec.a
                        );
...
//        glm::vec4 as_vec4();
         ...
         */
		const GLfloat* as_float_array() const {
            return &color_vec.x;
        }
